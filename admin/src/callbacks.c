...
FILE *f;
  ...
  f=fopen("/home/nidhal/Projects/admin/src/adherent.txt","r"); 
   ...
   if ((strcmp(ad.a_cin,cinn)==0))
	...
	output1=lookup_widget(fmodifier_adherent,"am_nom");
	output2=lookup_widget(fmodifier_adherent,"am_prenom");
	output3=lookup_widget(fmodifier_adherent,"am_cin");
	output4=lookup_widget(fmodifier_adherent,"am_jour");
	output5=lookup_widget(fmodifier_adherent,"am_mois");
	output6=lookup_widget(fmodifier_adherent,"am_an");
	output7=lookup_widget(fmodifier_adherent,"am_mail");
	output8=lookup_widget(fmodifier_adherent,"am_adresse");
...
FILE *f;
  ...
  f=fopen("/home/nidhal/Projects/admin/src/coach.txt","r"); 
   ...
   if ((strcmp(co.c_cin,cinn)==0))
	...
	output1=lookup_widget(fmodifier_coach,"cm_nom");
	output2=lookup_widget(fmodifier_coach,"cm_prenom");
	output3=lookup_widget(fmodifier_coach,"cm_cin");
	output4=lookup_widget(fmodifier_coach,"cm_jour");
	output5=lookup_widget(fmodifier_coach,"cm_mois");
	output6=lookup_widget(fmodifier_coach,"cm_an");
	output7=lookup_widget(fmodifier_coach,"cm_mail");
	output8=lookup_widget(fmodifier_coach,"cm_adresse");
...
FILE *f;
  ...
  f=fopen("/home/nidhal/Projects/admin/src/med.txt","r"); 
   ...
   if ((strcmp(med.m_cin,cinn)==0))
	...
	output1=lookup_widget(fmodifier_med,"mm_nom");
	output2=lookup_widget(fmodifier_med,"mm_prenom");
	output3=lookup_widget(fmodifier_med,"mm_cin");
	output4=lookup_widget(fmodifier_med,"mm_jour");
	output5=lookup_widget(fmodifier_med,"mm_mois");
	output6=lookup_widget(fmodifier_med,"mm_an");
	output7=lookup_widget(fmodifier_med,"mm_mail");
	output8=lookup_widget(fmodifier_med,"mm_adresse");
...
FILE *f;
  ...
  f=fopen("/home/nidhal/Projects/admin/src/diet.txt","r"); 
   ...
   if ((strcmp(diet.d_cin,cinn)==0))
	...
	output1=lookup_widget(fmodifier_diet,"dm_nom");
	output2=lookup_widget(fmodifier_diet,"dm_prenom");
	output3=lookup_widget(fmodifier_diet,"dm_cin");
	output4=lookup_widget(fmodifier_diet,"dm_jour");
	output5=lookup_widget(fmodifier_diet,"dm_mois");
	output6=lookup_widget(fmodifier_diet,"dm_an");
	output7=lookup_widget(fmodifier_diet,"dm_mail");
	output8=lookup_widget(fmodifier_diet,"dm_adresse");
...
FILE *f;
  ...
  f=fopen("/home/nidhal/Projects/admin/src/kine.txt","r"); 
   ...
   if ((strcmp(kine.k_cin,cinn)==0))
	...
	output1=lookup_widget(fmodifier_kine,"km_nom");
	output2=lookup_widget(fmodifier_kine,"km_prenom");
	output3=lookup_widget(fmodifier_kine,"km_cin");
	output4=lookup_widget(fmodifier_kine,"km_jour");
	output5=lookup_widget(fmodifier_kine,"km_mois");
	output6=lookup_widget(fmodifier_kine,"km_an");
	output7=lookup_widget(fmodifier_kine,"km_mail");
	output8=lookup_widget(fmodifier_kine,"km_adresse");
